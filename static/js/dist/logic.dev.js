...
var queryUrl = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson"; // Perform a GET request to the query URL/

d3.json(queryUrl).then(function (data) {
  // Define a function that we want to run once for each feature in the features array.
  // Give each feature a popup that describes the place and time of the earthquake.
  function bindpoptoearthquake(feature, layer) {
    layer.bindPopup("<h3>".concat(feature.properties.place, "</h3><hr><p>").concat(new Date(feature.properties.time), "</p>"));
  }
